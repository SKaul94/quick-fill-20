export const { directoryOpen, fileOpen, fileSave } = (function(){

  var T = Object.defineProperty;
  var f = (e, t) => () => (e && (t = e(e = 0)), t);
  var d = (e, t) => {for (var i in t) T(e, i, {get: t[i], enumerable: !0})};
  var y = {};
  d(y, {default: () => E});
  var E, p = f(() => {
    E = async (e = [{}]) => (Array.isArray(e) || (e = [e]), new Promise((t, i) => {
      ...
      let n = () => c(i), a = s => {typeof c == "function" && c(), t(s)},
        c = e[0].legacySetup && e[0].legacySetup(a, n, r);
      r.addEventListener("change", () => {a(r.multiple ? Array.from(r.files) : r.files[0])}), r.click()
    }))
  });
  var w = {};
  d(w, {default: () => I});
    ...
    N = async e => {
      ...
      e.forEach((l, n) => {
        t[n] = {
          ...
          accept: {}
        }, l.mimeTypes ? l.mimeTypes.map(a => {t[n].accept[a] = l.extensions || []}) : t[n].accept["*/*"] = l.extensions || []
      });
  ...
  var M, A = f(() => {
    M = async (e = [{}]) => (Array.isArray(e) || (e = [e]), e[0].recursive = e[0].recursive || !1, new Promise((t, i) => {
      ...
      let l = () => a(i), n = c => {typeof a == "function" && a(), t(c)},
  ...
  var v, B, g = f(() => {
    v = async (e, t, i = e.name, r) => {
      ...
      let t = await window.showDirectoryPicker({id: e.id, startIn: e.startIn});
  ...
  async function $(e, t) {
    let i = e.getReader(), r = new ReadableStream({
      start(n) {
        return a();

        async function a() {
          return i.read().then(({done: c, value: s}) => {
            if (c) {
              n.close();
              return
            }
    ...
    return i.releaseLock(), new Blob([await l.blob()], {type: t})
  }

  var W, P = f(() => {
    W = async (e, t = {}) => {
      Array.isArray(t) && (t = t[0]);
      let i = document.createElement("a"), r = e;
      "body" in e && (r = await $(e.body, e.headers.get("content-type"))), i.download = t.fileName || "Untitled", i.href = URL.createObjectURL(r);
      let l = () => a(reject), n = () => {typeof a == "function" && a()}, a = t.legacySetup && t.legacySetup(n, l, i);
      return i.addEventListener("click", () => {setTimeout(() => URL.revokeObjectURL(i.href), 30 * 1e3), n(null)}), i.click(), null
    }
  });
  var j = {};
  d(j, {default: () => q});
    ...
    q = async (e, t = [{}], i = null, r = !1) => {
      ...
      if (t.forEach((c, s) => {
        l[s] = {
          ...
          accept: {}
        }, c.mimeTypes ? (s === 0 && (e.type ? c.mimeTypes.push(e.type) : e.headers && e.headers.get("content-type") && c.mimeTypes.push(e.headers.get("content-type"))), c.mimeTypes.map(m => {l[s].accept[m] = c.extensions || []})) : e.type && (l[s].accept[e.type] = c.extensions || [])
      }), i) {
        try {await i.getFile()} catch (c) {
          if (i = null, r) {
            throw c
          }
        }
  ...
  var F = (() => {
    ...
    if ("top" in self && self !== top) {
      try {top.location + ""} catch {return !1}
  ...
  async function _(...e) {return (await U).default(...e)}

  var D = u ? Promise.resolve().then(() => (g(), x)) : Promise.resolve().then(() => (A(), o));

  async function O(...e) {return (await D).default(...e)}

  var z = u ? Promise.resolve().then(() => (L(), j)) : Promise.resolve().then(() => (P(), k));

  async function C(...e) {return (await z).default(...e)}

  return { directoryOpen: O, fileOpen: _, fileSave: C };
