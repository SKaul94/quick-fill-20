        ...
        if ( this.xmlDOM ){
            ...
            if ( this.allPersons ) for ( const person of this.allPersons ){
                ...
                menuNode.addEventListener('click', event => {
                    ...
                    this.htmlSpace.querySelectorAll('.selected_content').forEach( selected_content => selected_content.style.display = 'none' );
                    this.htmlSpace.querySelector('#selected_content_'+ person.uniqueNumber).style.display = 'block';
                });
                ...
                const binary = globalThis.pdfBinary && globalThis.pdfBinary[ kindOfPDF ];
                if ( binary ){
                    await pdfDoc.renderArrayBuffer( binary );
                    pdfDoc.applyRulesToTable( personName );
