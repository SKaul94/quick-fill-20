...
export const config = {
  ...
  initialRulesList: {
    ...
    Allgemein: [
      ...
      {rule_type: "equal", rule: "Eingabe-Nummer, E-Nummer", value: '${sonstigeNummer.nummernwert}$' },
      {rule_type: "equal", rule: "Text1", value: 'Asylgesuch - Polizei - AZR${sonstigeNummer.nummernwert}$' },
      {rule_type: "equal", rule: "Text2", value: 'Asylgesuch - ABH - AZR${sonstigeNummer.nummernwert}$' },
