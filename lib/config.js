...
export const config = {
  ...
  initialRulesList: {
    ...
    Allgemein: [
      ...
      {rule_type: "equal", rule: "Eingabe-Nummer, E-Nummer", value: '${AZR-Nummer}$' },
    ...
    template: [  // owner: 'template' is converted to owner: 'person' per person
      {rule_type: "equal", rule: "sprachmittler", value: '' },
      {rule_type: "equal", rule: "E-Nummer", value: '' },
      {rule_type: "equal", rule: "Eingabe-Nummer", value: '' },
    ],
  },
  ...
  xmlPersonalRules: {
    ...
    "geschlecht": "geschlecht, Geschlecht, f.geschlecht.1, f.geschlecht.2, Geschlecht",
    "familienstand": "familienstand, Familienstand, f.kk.10, Familienstand",
    "geburtsstaat": "geburtsstaat, Geburtsstaat, f.gebstaat.1, Geburt_Staat",
    "staatsangehoerigkeit": "staatsangehoerigkeit, Staatsangehoerigkeit, f.staat.1, Staatsangehoerigkeit",
  },
  ...
  autoFillXmlRelated: {
    "geschlecht.name": {
      "männlich": { name: "f.kk.2, f.kk.201", value: "maennlich" },
      "weiblich": { name: "f.kk.2, f.kk.201", value: "weiblich" },
      "divers": { name: "f.kk.2, f.kk.201", value: "divers" }
    },
  ...
  caseRules: [ 'Tagebuchnummer','Vorgangsnummer','Sammelvorgangsnummer','Familienname','Vorname','Geburtsname','Geburtsdatum','Geburtsort','Geburtsland','Familienstand','Staatsangehörigkeit', 'Beruf', 'PGÜ-Telefon', 'Straße', 'Hausnummer', 'Postleitzahl', 'Wohnort', 'Staat-des-Wohnorts', 'Aufgriffsort', 'Aufgriffsdatum', 'Kurzbeschreibung','Sprachmittler', 'AZR-Nummer' ],
