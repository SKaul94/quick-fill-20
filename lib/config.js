...
export const config = {
  ...
  initialRulesList: {
    ...
    Allgemein: [
      ...
      {rule_type: "equal", rule: "f.ort.1, f.checkliste_ort", value: "${Ort}$"},
      ...
      {rule_type: "equal", rule: "f.datum.1, f.dat.1, f.datum_datum, f.checkliste_datum", value: "${heute}$"},
      ...
      {rule_type: "equal", rule: "f.vorgangsnr.1, f.vorgangsnummer.1, f.vgnummer.1, f.checkliste_vorgangsnummer", value: "${Vorgangsnummer}$"},
      ...
      {rule_type: "equal", rule: 'geburtsdatum, f.gebdat.1, f.gebdatum.1, f.geburtsdatum.1', value: '${Geburtsdatum}$' },
      {rule_type: "equal", rule: 'geburtsort', value: '${Geburtsort}$' },
      ...
      {rule_type: "equal", rule: "vorname, f.vor.1, f.vorn.1, f.vorname.1", value: "${Vorname}$"},
      // {rule_type: "substring", rule: "vorn", value: "${Vorname}$"},

      {rule_type: "equal", rule: "Familienname", value: "${familienname.bezeichnung.2}$"},
      {rule_type: "equal", rule: "familienname, f.nach.1, f.nachn.1, f.nachname.1", value: "${Familienname}$"},
      ...
      {rule_type: "equal", rule: "staatsangehoerigkeit", value: "${Staatsangehörigkeit}$"},
  ...
  caseRules: [ 'Tagebuchnummer','Vorgangsnummer','Sammelvorgangsnummer','Familienname','Vorname','Geburtsname','Geburtsdatum','Geburtsort','Geburtsland','Familienstand','Staatsangehörigkeit', 'Beruf', 'PGÜ-Telefon', 'Straße', 'Hausnummer', 'Postleitzahl', 'Wohnort', 'Staat-des-Wohnorts', 'Aufgriffsort', 'Aufgriffsdatum', 'Kurzbeschreibung' ],
