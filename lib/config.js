...
export const config = quickFillConfig ? quickFillConfig : {
  ...
  /************* Rules in the Header of each person ******************/
  headerRules: {
  ...
  initialRulesList: {
    ...
    Allgemein: [
      {rule_type: "equal", rule: "Vorgangsnummer, vorgangsnr", value: "${Header-Vorgangsnummer}$"},
      {rule_type: "equal", rule: "AZR-Nummer, E-Nummer", value: "${Header-AZR-Nummer}$"},
