...
const quickFillConfigString = await Idb.get( configIdentifier );
...
export const config = quickFillConfig ? quickFillConfig : {
  ...
  configIdentifier: configIdentifier,  // see constant above
  ...
  initialRulesList: {
    ...
    Allgemein: [
      {rule_type: "equal", rule: "sprachmittler, sprachmittler_unterschrift", value: '${Sprachmittler}$' },
