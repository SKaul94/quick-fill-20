...
export class Rule  {
  ...
  static createNew({rule_type, rule, value, threshold, caseRule, pdf, owner, person}){
    const newRule = new Rule({rule_type, rule, value, threshold, caseRule, pdf, owner, person});
  ...
  isPersonRule(){
    return this.owner === 'person' || !! this.person;
  }
