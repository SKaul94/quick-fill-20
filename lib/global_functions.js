...
export async function getFromPasteBuffer( mimeType = 'image/' ){
  ...
  if( auth.state !== 'denied' ) {
    ...
    return item && await item.getType( image_type );
  }
}
...
export const shareSVG = `<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-share" viewBox="0 0 16 16">
