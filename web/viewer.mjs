...
class EventBus {
  ...
  dispatch(eventName, data) { console.log(`dispatch: ${eventName}`);
...
class PDFPrintService {
  ...
  useRenderedPage() {
    ...
    wrapper.append(img);
    this.printContainer.append(wrapper);  if ( this.pdfDocument.printImages ) this.pdfDocument.printImages.push( img ); // new: remember generated print images
